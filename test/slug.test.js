...
describe('slug', function() {
	...
	it('should replace cyrillic chars', function() {
		var char, char_map, expected, replacement, results;
		char_map = {
	...
	it('should strip symbols', function() {
		var char, char_map, i, len, results;
		char_map = ['†', '“', '”', '‘', '’', '•'];
		results = [];
	...
	it('should save some character', function() {
		var expected, text;
	...
	it('should save the dot character', function() {
		var expected, text;
		text = 'It\'s Your Journey We Guide You Through.';
		expected = 'Its-Your-Journey-We-Guide-You-Through.';
		return [
	...
	it('should save some characters', function() {
		var expected, text;
		text = 'It\'s Your/Journey We Guide You Through €.';
		expected = 'Its-Your/Journey-We-Guide-You-Through-€';
		return [
	...
	return it('should not crash when sending invalid input, but instead return false', function() {
		var expected, text;
		text = null;
		expected = false;
		return [slug(text)].should.eql([expected]);
	});
});